...
?>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      <h1>RoshDip - Change The Way You Trade...</h1>
...
<img src="img/pja1.jpg" style="width: 100%;">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left" data-aos-delay="200">
            ...
            <p class="font-italic"><b>Vision :</b> To provide a helping hand to the farmers in improving their lives through the medium of technology, thereby, improving the Agricultural Sector in the Indian Economy.
            </p>
            <ul>
              <li><i class="ri-check-double-line"></i> 'RoshDip' is a model farmer management website application..</li>
              <li><i class="ri-check-double-line"></i> 'RoshDip' provides a concept of virtual agricultural trade to its users.</li>
