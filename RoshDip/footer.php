  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-contact">
            ...
            <p>
              ...
              <strong>Phone:</strong> +91-8010820762<br>
              <strong>Email:</strong> info@roshdip.com<br>
            </p>
          </div>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright <strong><span>RoshDip</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
          Developed By GPD Students
        </div>
      </div>
