...
function sendmail($tomail, $totmailname , $subject, $message)
{
	...
	$mailsender = "RoshDip";
	$companyname= "RoshDip";
	$facebook = "https://www.facebook.com/RoshDip";
	$twitter = "https://www.twitter.com/RoshDip";
	$youtube = "https://www.youtube.com/RoshDip";
	$linkedin = "https://www.linkedin.com/RoshDip";
	$companyaddress  = "RoshDip";
	$contactno = "8010820762";
	$url = "www.roshdip.com";
